...
class AppointmentSummaryReports extends Page
{

    protected static ?string $navigationGroup = 'Reports ';
    protected static ?string $navigationLabel = 'Appointments Summary';
    protected static string $view = 'filament.resources.appointment-resource.pages.appointment-summary-reports';
    ...
    public function printPdf(): StreamedResponse
    {
        ...
        $pdf = Pdf::loadHTML(view('pdf.appointment-summary-report', [
